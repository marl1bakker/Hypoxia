...
function SeedGenerator(DataFolder, ROI_input, ManualInput)

if ~exist('ManualInput', 'var')
    ManualInput = 0;
end

if( exist([DataFolder 'Timecourses.mat'], 'file') && ManualInput == 0 )
    disp('Timecourses already calculated, function exited')
    return
elseif( exist([DataFolder 'Timecourses.mat'], 'file') && ManualInput == 1 )
...
%         timecourse = mean(dat(Seed(:), :), 1);
    ...
    save([DataFolder 'Timecourses.mat'], 'Timecourses');
